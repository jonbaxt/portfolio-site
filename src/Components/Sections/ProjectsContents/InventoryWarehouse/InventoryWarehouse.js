...
import {
    // invLink,
    invText1, invText2, invText3, technologiesIntroText, technologiesUsed, vid1Intro, vidLink1, vid2Intro, vidLink2, vid2Outro } from './InventoryText';
    ...
    return (
        <div className={css(projectStyles.main)}>
            <div className={css(projectStyles.container)}>
                ...
                {/*<a className={css(projectStyles.linkLine)} href={invLink()} target='_blank' rel='noopener noreferrer' ><p className={css(projectStyles.linkStyle)}>Live Site Link</p></a>*/}

                <div className={'picContainer'}>
                    <img className={'containerImageSized'} src={HomeScreenPic} alt='homescreen' />
                </div>
