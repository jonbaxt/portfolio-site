    ...
    return (
        <div className={css(projectStyles.main)}>
            <div className={css(projectStyles.container)}>
                ...
                <a className={css(projectStyles.linkLine)} href={NSCLinkSite()} target='_blank'><p className={css(styles.linkStyle)}>Live Site Link</p></a>
                ...
                <div className={css(projectStyles.picContainer)}>
                    <img className={css(projectStyles.picSizing)} src={NSCPic} alt='' />
                </div>
