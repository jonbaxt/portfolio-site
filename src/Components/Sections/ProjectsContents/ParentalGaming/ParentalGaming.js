    ...
    return (
        <div className={css(projectStyles.main)}>
            <div className={css(projectStyles.container)}>
                ...
                <a className={css(projectStyles.linkLine)} href={ParSiteLink()} target='_blank'><p className={css(projectStyles.linkStyle)}>Live Site Link</p></a>
                ...
                <div className={css(projectStyles.picContainer)}>
                    <img className={css(projectStyles.picSizing)} src={ParGamPic1} alt='' />
                </div>
                ...
                <div className={css(projectStyles.picContainer)}>
                    <img className={css(projectStyles.picSizing)} src={ParGamPic2} alt='' />
                    <img className={css(projectStyles.picSizing)} src={ParGamPic3} alt='' />
                    <img className={css(projectStyles.picSizing)} src={ParGamPic4} alt='' />
                </div>
